...
export default function AddProjectPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const featuredData = await safeApiCall('https://api.rkinteriorstudio.in/api/upload', {
        method: 'POST',
      ...
      const galleryUploadPromises = galleryImages.map(async (img) => {
        ...
        const data = await safeApiCall('https://api.rkinteriorstudio.in/api/upload', {
          method: 'POST',
          body: fd
        });
        return data.url;
      ...
      await safeApiCall('https://api.rkinteriorstudio.in/api/projects', {
        method: 'POST',
