...
export default function ManageAdminsPage() {
  ...
  const fetchAdmins = async () => {
    try {
      const response = await fetch('https://kotiboxglobaltech.site/api/users');
  ...
  const handleAddAdmin = async (e: React.FormEvent) => {
    ...
    setCreating(true);
    try {
      const response = await fetch('https://kotiboxglobaltech.site/api/users/create-admin', {
        method: 'POST',
  ...
  const handleDeleteAdmin = async (adminId: string) => {
    ...
    setDeleting(adminId);
    try {
      const response = await fetch(`https://kotiboxglobaltech.site/api/users/${adminId}`, {
        method: 'DELETE'
      });
